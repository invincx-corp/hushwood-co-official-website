      ...
      <main className="pt-20">
        ...
        <section className="py-20 bg-gradient-subtle">
          <div className="max-w-7xl mx-auto px-6">
            <h2 className="text-4xl font-bold text-center text-primary mb-4">Visit Our Offices</h2>
              ...
              {locations.map((location, index) => (
                <Card key={index} className="hover:shadow-elegant transition-spring">
                  <CardContent className="p-8">
                    ...
                    <h3 className="text-2xl font-bold text-primary mb-4">{location.city}</h3>
            ...
            <div className="flex justify-center gap-6">
              {socialLinks.map((social, index) => (
                <a
                  key={index}
                  href={social.url}
                  className="w-16 h-16 gradient-gold rounded-full flex items-center justify-center hover:shadow-elegant transition-spring hover:-translate-y-1"
        ...
        <section className="py-20 bg-gradient-subtle">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-4xl font-bold text-primary mb-4">Have Questions?</h2>
